...
class Decoder(nn.Module):
    ...
    def train_decoder(self, train_loader, classifier, val_loader=None, num_epochs=5, lr=0.001, patience=5, model_saves_dir=None, reconstruction_criterion=nn.MSELoss()):
...
def train_joint(classifier, decoder, train_loader, val_loader=None, num_epochs=5, lr=0.001, lambda_recon=0.5, patience=5, model_saves_dir=None, reconstruction_loss=nn.MSELoss()):
